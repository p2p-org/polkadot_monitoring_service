...
async def command_build(message: Message) -> None:
    ...
    if instance_count_5m >= 3:
        await message.answer("❗ A lot of deployments at this moment.\nPlease wait for couple of minutes.\n\nFeel free to contact us /support to solve it.",reply_markup=ReplyKeyboardRemove())
        await bot.send_message(admin_chat, "❗❗❗ A lot of deployments last 5 minutes❗❗❗",reply_markup=ReplyKeyboardRemove())
        return
